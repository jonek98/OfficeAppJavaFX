...
public class WarehouseWorkerSceneController {
            ...
            if (event.getSource() == back) {
                ...
                if (first_name.getText().isEmpty() || last_name.getText().isEmpty() || salary.getText().isEmpty()) {
                    ...
                    try {
                        ...
                        Warehouse_worker warehouse_worker_temp = new Warehouse_worker(first_name, last_name, salary, date, idd);

                        Database.getInstance().getPeople().add(warehouse_worker_temp);

                        warning.setTextFill(Color.GREEN);
                        warning.setText("Warehouse Worker has been added successfully! ");
